...
public class TestNIO_2 {
	...
	public void test6() throws IOException {
		Path path = Paths.get("o:/nio/hello7.txt");
//		System.out.println(Files.exists(path, LinkOption.NOFOLLOW_LINKS));
	...
	public void test5() throws IOException {
		Path path1 = Paths.get("o:/nio/hello2.txt");
		Path path2 = Paths.get("o:/nio/hello7.txt");
...
//		Files.move(path1, path2, StandardCopyOption.ATOMIC_MOVE);
	...
	public void test4() throws IOException {
		Path dir = Paths.get("o:/nio/nio2");
//		Files.createDirectory(dir);
		
		Path file = Paths.get("o:/nio/nio2/hello3.txt");
//		Files.createFile(file);
	...
	public void test3() throws IOException {
		Path path1 = Paths.get("o:/nio/hello.txt");
		Path path2 = Paths.get("o:/nio/hello2.txt");
	...
	@Test
	public void test2() {
		Path path = Paths.get("o:/nio/hello.txt");
...
//		System.out.println(newPath);
	...
	public void test1() {
		...
		System.out.println(path.endsWith("hello.txt")); //true
		System.out.println(path.startsWith("o:/"));   //true
		
		System.out.println(path.isAbsolute());          //true
		System.out.println(path.getFileName());        //true
