...
public class _5_MergeSort {
    /*public static void mergeSort(int[] nums, int[] tmp, int left, int right) {
        if (left < right) {
    ...
    public static void merge(int[] nums, int[] tmp, int leftPos, int rightPos, int rightEnd) {
        ...
        while (leftPos <= leftEnd && rightPos <= rightEnd) {
            if (nums[leftPos] - nums[rightPos] <= 0) {
